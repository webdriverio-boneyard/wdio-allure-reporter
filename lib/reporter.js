    ...
    constructor (baseReporter, config, options = {}) {
        ...
        this.on('end', () => {
            try {
                ...
                browser.logger.error(`Failed parsing stats for Allure reporter: ${e.message}. Dumped this.baseReporter.stats to ${logFile}.`)
                browser.logger.error(e.stack)
            }
        ...
        for (let cid of Object.keys(stats.runners)) {
            ...
            for (let specId of Object.keys(runner.specs)) {
                ...
                for (let suiteName of Object.keys(spec.suites)) {
                    ...
                    browser.logger.log(`Wrote Allure report for ${suiteName} to [${this.outputDir}].`)
                }
            }
        }
    }
