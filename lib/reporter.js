    ...
    constructor (baseReporter, config, options = {}) {
        ...
        this.on('end', () => {
            try {
                ...
                console.log()
                console.log(`Failed parsing stats for Allure reporter: ${e.message}. Dumped this.baseReporter.stats to ${logFile}.`)
                console.log(e.stack)
            }
                ...
                for (let suiteName of Object.keys(spec.suites)) {
                    ...
                    for (let testName of Object.keys(suite.tests)) {
                        ...
                        if (this.preTestOutput && this.preTestOutput.length) {
                            ...
                            this.endStep('passed', this.preTestOutput[(this.preTestOutput.length - 1)].payload.time.getTime())
    ...
    addOutput (events) {
        ...
        events.map((event, index) => {
            ...
            case 'screenshot':
                ...
                this.endStep('screenshot', screenshotEnd)
                break
            case 'log':
