...
class AllureReporter extends events.EventEmitter {
    constructor (baseReporter, config, options = {}) {
        ...
        this.on('suite:start', (suite) => {
            ...
            this.allure.startSuite(title, this.getTime())
        })
        ...
        this.on('suite:end', (suite) => {
            ...
            this.allure.endSuite(this.getTime())
        ...
        this.on('test:start', (test) => {
            ...
            this.allure.startCase(title, this.getTime())
        })
        ...
        this.on('test:pending', (test) => {
            ...
            this.allure.pendingCase(title, this.getTime())
        })
        ...
        this.on('test:pass', (test) => {
            ...
            this.allure.endCase('passed', null, this.getTime())
        })
        ...
        this.on('test:fail', (test) => {
            ...
            if(latestHook) {
                ...
                if(latestHook.currentTest === test.currentTest) {
                    this.allure.startCase(title, this.getTime())
                    this.allure.endCase('failed', test.err, this.getTime())
                    return;
                }
            ...
            this.popParent()
            this.print('test:fail >', title, this.level)
            this.allure.endCase('failed', test.err, this.getTime())
